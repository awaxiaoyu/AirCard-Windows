...
pub struct AppleLibraries {
    ...
    pub at_host_connection_create: unsafe extern "C" fn(CFStringRef, CFTypeRef) -> ATHostConnectionRef,
    pub at_host_connection_release: unsafe extern "C" fn(ATHostConnectionRef),
    pub at_host_connection_send_host_info: unsafe extern "C" fn(ATHostConnectionRef, CFDictionaryRef) -> i32,
    pub at_host_connection_send_sync_request: unsafe extern "C" fn(ATHostConnectionRef, CFArrayRef, CFDictionaryRef, CFDictionaryRef) -> i32,
    pub at_host_connection_send_metadata_sync_finished: unsafe extern "C" fn(ATHostConnectionRef, CFDictionaryRef, CFDictionaryRef) -> i32,
    pub at_host_connection_send_asset_completed: unsafe extern "C" fn(ATHostConnectionRef, CFStringRef, CFStringRef, CFStringRef) -> i32,
